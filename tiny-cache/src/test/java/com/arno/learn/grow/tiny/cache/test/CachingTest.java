 ...
 */
package com.arno.learn.grow.tiny.cache.test;

import com.arno.learn.grow.tiny.cache.test.event.TestCacheEntryListener;
...
import static com.arno.learn.grow.tiny.cache.configruation.ConfigurationUtils.cacheEntryListenerConfiguration;
...
public class CachingTest {
    ...
    public void testSampleInMemory() {
        ...
        // create the cache
        Cache<String, Integer> cache1 = cacheManager.createCache("simpleCache", config);

        // add listener
        cache1.registerCacheEntryListener(cacheEntryListenerConfiguration(new TestCacheEntryListener<>()));
