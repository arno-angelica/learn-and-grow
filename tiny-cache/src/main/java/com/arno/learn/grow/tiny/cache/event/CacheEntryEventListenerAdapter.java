...
public class CacheEntryEventListenerAdapter<K, V> implements ConditionalCacheEntryEventListener<K, V> {
    ...
    private static final Object[] eventTypesAndHandleMethodNames = new Object[] {
    ...
    public boolean equals(Object object) {
        ...
        CacheEntryEventListenerAdapter<K, V> another = (CacheEntryEventListenerAdapter<K, V>) object;
    ...
    private Map<EventType, Method> determineEventTypeMethods(CacheEntryListener<? super K, ? super V> cacheEntryListener) {
        ...
        for (int i = 0; i < eventTypesAndHandleMethodNames.length; ) {
            EventType eventType = (EventType) eventTypesAndHandleMethodNames[i++];
            String handleMethodName = (String) eventTypesAndHandleMethodNames[i++];
            try {
